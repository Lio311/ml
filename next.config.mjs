    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://*.clerk.accounts.dev https://clerk.ml-tlv.com https://*.clerk.services https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms https://browser.sentry-cdn.com https://*.sentry.io; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://www.gstatic.com; img-src 'self' data: blob: https://*.clerk.com https://clerk.ml-tlv.com https://*.clerk.accounts.dev https://*.googleusercontent.com https://images.unsplash.com https://*.fimgs.net https://*.pimgs.net https://*.fragrantica.com https://www.cp-parfums.com https://wp.logos-download.com https://ipiccirilliperfumes.com https://aromadilamore.com https://encrypted-tbn0.gstatic.com https://www.google-analytics.com https://*.clarity.ms https://*.sentry.io; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://*.clerk.accounts.dev https://clerk.ml-tlv.com https://*.clerk.services https://www.google-analytics.com https://*.clarity.ms https://*.sentry.io; frame-src 'self' https://*.clerk.accounts.dev https://clerk.ml-tlv.com https://*.clerk.services; worker-src 'self' blob:; object-src 'none'; base-uri 'self'; form-action 'self';"
          }
        ],
      },
    ];
