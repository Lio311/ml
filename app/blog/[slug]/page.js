    ...
    return (
        <div className="container py-12 max-w-4xl mx-auto">
            ...
            <article className="bg-white p-6 md:p-16 rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden relative">
                ...
                <div className="mt-16 pt-12 border-t border-gray-50 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex gap-3">
                         <a href={`https://wa.me/?text=${t('common.interesting_article')} ${localizedTitle} - https://www.ml-tlv.com/blog/${slug}`} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-green-500 text-white flex items-center justify-center hover:scale-110 transition shadow-lg shadow-green-200">
            ...
            <div className="mt-12 text-center">
                <h3 className="text-xl font-bold mb-4">{t('common.liked_article')}</h3>
                <Link href="/catalog" className="btn btn-primary px-8 py-3 text-lg">
                    {t('common.discover_catalog')}
                </Link>
            </div>
        </div>
    );
