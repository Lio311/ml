...
export default async function Home() {
  ...
  try {
    await withClient(async (client) => {
      ...
      const res = await client.query('SELECT id, brand, model, price_2ml, price_5ml, price_10ml, image_url, category, in_lottery, slug, description, stock, brand_he, model_he, original_size, created_at, discount_percentage, discount_sizes FROM products WHERE active = true AND stock > 0 ORDER BY created_at DESC LIMIT 6');
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <section className="relative h-[68vh] md:h-[79vh] w-full m-0 p-0 overflow-hidden bg-white block !-mt-20 md:mt-0">
