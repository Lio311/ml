...
export const sendEmail = async (to, subject, html, type = 'system', orderId = null, campaignId = null, attachments = []) => {
    ...
    try {
        ...
        const isMarketing = ['manual_campaign', 'marketing', 'recommendations', 'new_product', 'new_preorder', 'review_request', 'cart_recovery', 'educational', 'nurture_10_days', 'nurture_25_days', 'discovery_launch', 'new_perfumes_batch', 'monthly_discovery'].includes(type) || campaignId !== null;
