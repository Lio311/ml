                    ...
                    <table className="w-full text-right" dir="rtl">
                        <thead className="bg-gray-50/50 text-gray-400 text-[10px] font-black uppercase tracking-widest border-b border-gray-100">
                            <tr>
                                ...
                                <th className="p-5">שכר בסיס</th>
                                <th className="p-5">עמלה (%)</th>
                                <th className="p-5">קופון משויך</th>
                                <th className="p-5">שימושים</th>
                                <th className="p-5">סה"כ מכירות (נטו)</th>
                                <th className="p-5">שכר משפיען</th>
