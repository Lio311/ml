...
export default function DownloadBatchOrderPDF({ selectedOrders, onComplete }) {
    ...
    return (
        <button 
            ...
            className="w-full md:w-auto bg-white text-gray-900 rounded-lg px-4 py-2 text-sm font-bold hover:bg-gray-100 transition flex items-center justify-center gap-2"
