...
export default function DownloadBatchOrderPDF({ selectedOrders, onComplete }) {
    ...
    return (
        <button 
            ...
            className="w-full md:w-auto bg-white border border-gray-200 shadow-sm text-gray-800 rounded-xl px-4 py-2 text-sm font-bold hover:bg-gray-50 transition flex flex-row-reverse items-center justify-center gap-2 whitespace-nowrap text-nowrap"
