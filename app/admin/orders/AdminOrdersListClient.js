...
export default function AdminOrdersListClient({ 
    ...
    return (
        <div className="pb-8 relative">
            ...
            <div className="absolute left-0 top-0 md:top-0 flex items-center gap-2 z-10 translate-y-16 md:translate-y-14">
            ...
            <div className="flex flex-col xl:flex-row items-start xl:items-center justify-center gap-4 mb-24 md:mb-6 relative min-h-[44px] xl:min-h-[64px]">
