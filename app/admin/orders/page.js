...
export default async function AdminOrdersPage(props) {
    ...
    try {
        const [ordersRes, countRes] = await Promise.all([
            client.query('SELECT id, items, total_amount, status, customer_details, created_at, invoice_url, catalog_id, free_samples_count FROM orders WHERE catalog_id IS NULL ORDER BY created_at DESC LIMIT $1 OFFSET $2', [LIMIT, offset]),
