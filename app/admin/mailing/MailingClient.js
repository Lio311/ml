...
export default function MailingClient() {
    ...
    const getTemplateCategory = (slug) => {
        ...
        if (['back_in_stock', 'new_product', 'new_perfumes_batch', 'new_discovery_sets', 'new_preorder'].includes(slug)) return 'inventory';
        return 'general';
    };
        ...
        const mockData = {
                    ...
                    <tbody>
                        <tr style="border-bottom: 1px solid #f5f5f5;">
                            <td style="padding: 12px 10px; text-align: right; font-size: 14px; color: #333;">
                                <img src={`https://${brand.hyphen}.com/api/assets/logo?type=logo_email`} width="40" style="vertical-align: middle; margin-left: 10px; border-radius: 6px; display: inline-block; border: 1px solid #f0f0f0; height: auto; max-height: 40px; object-fit: contain;" alt="product test" />
            ...
            itemsHtmlAdmin: `
                <li style="margin-bottom: 12px; border-bottom: 1px solid #f0f0f0; padding-bottom: 12px; display: table; width: 100%;">
                    <div style="display: table-cell; vertical-align: middle; width: 50px;"><img src={`https://${brand.hyphen}.com/api/assets/logo?type=logo_email`} width="40" style="border-radius: 6px; border: 1px solid #f0f0f0; height: auto; max-height: 40px; object-fit: contain;" alt="product test" /></div>
