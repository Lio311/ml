...
export default async function AdminLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row w-full max-w-full overflow-x-hidden" dir="rtl">
            <AdminMobileNav role={currentRole} />
            <AdminSidebar role={currentRole} />
            <main className="flex-1 p-2 md:p-8 relative w-full overflow-x-hidden">
