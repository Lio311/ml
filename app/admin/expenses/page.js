...
export default function AdminExpensesPage() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY) { // Just a random check, actual logic is below
            // ...
        }
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border mb-8">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-end">
                        ...
                        <button
                            ...
                            className="bg-black text-white px-6 py-2 rounded font-bold hover:bg-gray-800 disabled:opacity-50 h-[42px]"
                        >
                            {isSubmitting ? '...' : 'הוסף'}
                        </button>
                    </form>
