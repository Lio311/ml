...
export async function generateMetadata(props) {
    ...
    const { slug } = params;
    const res = await pool.query(`SELECT id, slug, brand, brand_he, model, model_he, name, name_he, description, description_en, image_url, category, stock, top_notes, middle_notes, base_notes, price_2ml, price_5ml, price_10ml FROM products WHERE slug = $1 OR id::text = $1`, [slug]);
