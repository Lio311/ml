                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10">
                        ...
                        >
                            ...
                            <div className="relative w-full max-w-xl flex justify-end">
                                {/* Main Image - Preserving Ratio, Slightly Smaller & Shifted Right */}
                                <motion.div 
                                    className="relative w-96 mr-0 ml-auto rounded-[2.5rem] shadow-[0_60px_120px_-20px_rgba(0,0,0,0.2)] overflow-hidden border border-white bg-white z-10"
                                    style={{ rotateX: 12, rotateY: -15, transformPerspective: 1200 }}
                                ...
                                {/* Floating Bottom Left Card - Slightly Smaller & Shifted MUCH Further Left */}
                                <motion.div 
                                    className="absolute -bottom-12 -left-36 w-80 shadow-2xl rounded-2xl border border-white/80 overflow-hidden bg-white/90 backdrop-blur-sm p-3 z-30"
                                    initial={{ y: 20 }}
                                    animate={{ y: 0 }}
