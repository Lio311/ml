        ...
        <div className="container mx-auto py-12 px-6 max-w-4xl text-right" dir="rtl">
            ...
            <section className="mb-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 bg-gray-50 p-6 rounded-lg border">
                    <li>כפתור התאמת האתר ותגיות האתר עבור מכשירי עזר וטכנולוגיות</li>
                    <li>כפתור ניווט בעזרת מקשי המקלדת</li>
                    <li>כפתור השבתת הבהובים ו/או אלמנטים נעים</li>
                    <li>כפתור מצב מונוכרום (שחור לבן) לעיוורי צבעים</li>
                    ...
                    <li>כפתור הצגת תיאור חלופי (Alt) לתמונות</li>
                    <li>כפתור גופן קריא</li>
                    <li>כפתור הגדלת/הקטנת גופנים</li>
                    <li>כפתור הגדלת/הקטנת התצוגה (Zoom)</li>
                    <li>כפתור הגדלת סמן העכבר (לבן/שחור)</li>
                    <li>כפתור מצב קריאה ("מדריך קריאה")</li>
