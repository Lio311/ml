            ...
            >
                ...
                <section className="h-screen w-full flex flex-col bg-white overflow-hidden">
                    ...
                    <div className="relative w-full h-[60%] flex items-center justify-center overflow-hidden">
                        ...
                        <div className="relative z-10 text-center text-black bg-white/80 p-6 md:px-12 rounded-xl backdrop-blur-sm shadow-sm max-w-3xl mx-4">
                            <h2 className="text-xs tracking-[0.2em] uppercase mb-2 font-bold opacity-90">
                                Discover Your Signature Scent
                            </h2>
                            <h1 className={`${dancingScript.className} text-4xl md:text-5xl font-bold mb-3 leading-tight md:whitespace-nowrap`}>
