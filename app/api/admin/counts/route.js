...
const getCachedAdminCounts = async (userId) => {
    return unstable_cache(
        ...
        [`admin-counts-${userId}`], // Base cache key dynamically includes userId
        { revalidate: 60, tags: ['admin-counts', `admin-counts-${userId}`] } // Cache for 60 seconds
    )();
};
