    ...
    return (
        <div className="fixed bottom-6 left-6 z-50 font-sans group" style={{ direction: 'rtl' }}>
            ...
            <button
                ...
                title="תפריט נגישות"
            >
                {/* Accessibility Icon (Vito Style - High Quality SVG) */}
                <svg xmlns="http://www.w3.org/2000/svg" className="h-full w-full p-2" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2zm0 2c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm0 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm4 13l-4-4-4 4-1.41-1.41L10 14.17v-3.76l-2.8-2.8.6-.6 3.4 3.4 3.4-3.4.6.6-2.8 2.8v3.76l3.41 3.41L16 19z" />
                </svg>
            </button>
