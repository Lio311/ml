        ...
        <div className="fixed bottom-6 left-6 z-50 font-sans" style={{ direction: 'rtl' }}>
            ...
            {!isOpen && (
                <button
                    ...
                    className="absolute -top-2 -right-2 z-50 bg-gray-200 text-gray-600 rounded-full p-1 opacity-0 hover:opacity-100 transition shadow-sm hover:bg-red-500 hover:text-white"
