...
// Dummy data for representative (replace with actual data source)
const REPRESENTATIVES = [
    { id: 1, name: 'אליס', image: '/images/rep-f1.webp', role: 'יועצת יופי', gender: 'female' },
    { id: 2, name: 'דניאל', image: '/images/rep-m1.webp', role: 'מומחה בשמים', gender: 'male' },
    { id: 3, name: 'נועה', image: '/images/rep-f2.webp', role: 'יועצת לקוחות', gender: 'female' },
];
...
export default function ChatbotWidget() {
    ...
    const [rep, setRep] = useState(REPRESENTATIVES[0]); // Default rep
