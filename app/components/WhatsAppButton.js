    ...
    return (
        <div className={`fixed z-50 ${isChatClosed ? 'bottom-6' : 'bottom-[88px]'} ${dir === 'rtl' ? 'right-6' : 'left-6'} transition-all duration-300 group`}>
            <a 
                ...
                className="bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 hover:scale-110 flex items-center justify-center transition-all duration-300"
