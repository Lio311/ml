        ...
        <div className="md:hidden">
            <div className="bg-[#050505] text-white p-4 flex justify-between items-center shadow-lg sticky top-0 z-50 border-b border-white/[0.06]">
                ...
                <span className="font-black text-lg tracking-tighter italic uppercase flex items-center gap-1">
                    {brand.name?.split(' ')[0]} <span className="text-blue-500 not-italic text-xs bg-blue-500/10 px-1 rounded border border-blue-500/20">PRO</span>
                </span>
            </div>
            ...
            <div className={`fixed top-0 right-0 h-full w-72 bg-[#0a0a0a] z-50 transform transition-transform duration-500 ease-in-out shadow-2xl border-l border-white/[0.06] ${isOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 invisible'}`}>
                <div className="p-6 flex flex-col h-full">
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            <h2 className="text-xl font-black italic uppercase tracking-tighter text-white">{brand.name}</h2>
                            <p className="text-[10px] text-gray-500 font-mono tracking-widest uppercase">System Control v4.0</p>
                        </div>
