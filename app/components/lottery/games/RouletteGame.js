        ...
        <div className="flex flex-col items-center justify-center p-8">
            ...
            <div className="relative w-64 h-64">
                ...
                {!spinning && !finished && (
                    <button
                        onClick={handleSpin}
                        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-yellow-500 rounded-full flex items-center justify-center font-bold border-4 border-white shadow-lg hover:scale-110 transition-transform z-20 text-black"
                    >
                        SPIN
                    </button>
                )}
                ...
                {finished && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 rounded-full animate-fade-in z-30">
                        ...
                        <div className="text-center">
                            <p className="text-yellow-400 font-bold text-sm">{prize.brand}</p>
