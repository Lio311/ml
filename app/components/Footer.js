            ...
            <div className={`container grid grid-cols-2 md:grid-cols-5 gap-4 text-center py-4 ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>
                ...
                <div>
                    ...
                    <ul className={`space-y-2 text-sm text-gray-400`}>
                        ...
                        <li>
                            <a href="https://wa.me/972502266071" target="_blank" rel="noopener noreferrer" className="hover:text-white transition flex items-center justify-center md:justify-start gap-2">
