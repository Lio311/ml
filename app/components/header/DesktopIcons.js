    ...
    return (
        <div className="flex items-center justify-end gap-6">
            ...
            <Link href="/wishlist" className="relative group text-black" title="מועדפים">
                ...
                {wishlistCount > 0 && (
                    <span className="absolute -top-2 -right-2 flex h-4 w-4 items-center justify-center rounded-full bg-black text-[9px] text-white font-bold">
                        {wishlistCount}
                    </span>
                )}
            </Link>
            ...
            <Link href="/cart" className="relative group text-black" title="עגלה">
                ...
                {cartCount > 0 && (
                    <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-black text-[9px] text-white font-bold border-2 border-white shadow-sm">
                        {cartCount}
                    </span>
                )}
            </Link>
