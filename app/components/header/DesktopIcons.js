    ...
    return (
        <div className="flex items-center justify-end gap-5">
            ...
            <Link href="/wishlist" className="relative group text-black" title={t('common.wishlist_title')}>
                ...
                {wishlistCount > 0 && (
                    <span className="absolute -top-1.5 -end-1.5 flex h-[18px] w-[18px] items-center justify-center rounded-full bg-black text-[10px] text-white font-bold border border-white shadow-sm">
                        {wishlistCount}
                    </span>
                )}
            </Link>
