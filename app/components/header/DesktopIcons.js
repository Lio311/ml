    ...
    return (
        <div className="flex items-center justify-end gap-5">
            ...
            <Link href="/wishlist" className="relative group text-black" title={t('common.wishlist_title')}>
                ...
                {wishlistCount > 0 && (
                    <span className="absolute -top-2 -end-2 flex h-4 w-4 items-center justify-center rounded-full bg-black text-[9px] text-white font-bold">
                        {wishlistCount}
                    </span>
                )}
            </Link>
            ...
            {/* Cart */}
            <Link href="/cart" className="relative group text-black" title={t('common.cart_title')}>
                ...
                {cartCount > 0 && (
                    <span className="absolute -top-1 -end-1 flex h-4 w-4 items-center justify-center rounded-full bg-black text-[9px] text-white font-bold border-2 border-white shadow-sm">
                        {cartCount}
                    </span>
                )}
            </Link>
