...
export default function HomeSEOContent() {
    return (
        <section className="pt-20 pb-0 bg-black text-white overflow-hidden" dir="rtl">
            <div className="container mx-auto px-6 md:px-12 max-w-6xl">
                <div className="text-right">
                    {/* Premium Header */}
                    <div className="mb-16 text-center md:text-right">
                        <span className="text-xs uppercase tracking-[0.3em] text-gray-500 font-bold mb-3 block">Premium Fragrance Guide</span>
                        <h2 className="text-4xl md:text-5xl font-serif font-black text-white mb-6 leading-[1.1]">
                            המדריך המלא לעולם ה-דיקאנטים: <br className="hidden md:block" />
                            איך לבחור את ה-בושם המושלם עבורך?
                        </h2>
                        <div className="w-20 h-1.5 bg-yellow-500 rounded-full mx-auto md:mx-0"></div>
                    </div>

                    {/* Content Blocks - Two Columns on Desktop */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 text-gray-300 leading-relaxed text-justify font-light text-lg">
                        <div className="space-y-6">
                            ...
                            <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 shadow-sm space-y-4">
                                <h3 className="text-xl font-serif font-bold text-white">למה לבחור בדוגמיות?</h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <h3 className="text-2xl font-serif font-bold text-white pt-4">מגוון בשמי הנישה והיוקרה הגדול בישראל</h3>
                            <p>
                    ...
                    <div className="mt-20 space-y-16">
                        <div className="p-10 md:p-16 bg-zinc-900 rounded-[3rem] border border-zinc-800 shadow-sm relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-zinc-800 rounded-full -translate-y-16 translate-x-16 group-hover:scale-110 transition-transform duration-700"></div>
                            ...
                            <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
                                <p className="text-xl font-bold text-white text-center md:text-right">
