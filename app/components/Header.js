                    ...
                    <div className="flex-1 flex justify-center items-center">
                        ...
                        <div className="hidden md:flex flex-col items-center gap-2">
                            ...
                            <nav className="flex items-center gap-6 lg:gap-8">
                                ...
                                <Link href="/matching" className={`px-5 py-2 text-sm font-bold tracking-widest transition rounded-sm ${pathname === '/matching' ? 'bg-black text-white' : 'text-gray-900 hover:bg-black hover:text-white'}`}>התאמת בשמים</Link>
