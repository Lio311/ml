...
export default function MobileNavV2({ menu = [], cartCount, wishlistCount, isAdmin }) {
    ...
    return (
        <>
            ...
            <div className="flex md:hidden justify-between items-center w-full z-20">
                ...
                {/* Logo */}
                <Link href="/v2" className="inline-block absolute left-1/2 transform -translate-x-1/2">
