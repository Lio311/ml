...
export async function generateMetadata(props) {
    ...
    if (!product) {
        return {
            title: "Î×ÎòÎªÎ¿ Î£ÎÉ ÎáÎ×ÎªÎÉ | ml_tlv",
            description: "ÎöÎæÎòÎ®ÎØ Î®ÎùÎÖÎñÎ®Î¬ Î£ÎÉ ÎáÎ×ÎªÎÉ.",
        };
    }
    ...
    const title = `${product.name} | ÎöÎùÎ£ Î×-${product.price_2ml}Ôé¬`;
    const description = product.description ? product.description.substring(0, 160) : `ÎºÎáÎò ÎôÎòÎÆÎ×ÎÖÎ¬ Î®Î£ ${product.name} ÎæÎÉÎ¬Î¿ ml_tlv. ÎæÎ®Î×ÎÖÎØ Î×ÎºÎòÎ¿ÎÖÎÖÎØ ÎòÎ×ÎÖÎòÎùÎôÎÖÎØ.`;
...
export default async function ProductPage(props) {
    ...
    if (!product) {
        return <div className="p-20 text-center">Î×ÎòÎªÎ¿ Î£ÎÉ ÎáÎ×ÎªÎÉ</div>;
    }
    ...
    return (
        <div className="container py-12">
            <div className="flex flex-col md:flex-row items-start gap-12 mb-20">
                ...
                <div className="w-full md:w-1/2 aspect-square bg-white rounded-xl flex items-center justify-center relative overflow-hidden shadow-sm p-8 md:p-12 group">
                    {product.image_url ? (
                        ...
                        <div className="text-6xl text-gray-300">­ƒº┤</div>
                    )}
                ...
                <div className="w-full md:w-1/2 space-y-8">
                    <div>
                                ...
                                __html: JSON.stringify({
                                    ...
                                    "itemListElement": [
                                        ...
                                        },
                                        {
                                            "@type": "ListItem",
                                            "position": 3,
                                            "name": product.category || "ÎøÎ£Î£ÎÖ",
                        ...
                        <div className="text-lg text-gray-600 leading-relaxed">
                            {product.description || `Î¬ÎÖÎÉÎòÎ¿ Î×ÎòÎªÎ¿ Î×ÎòÎ¿ÎùÎæ ÎÖÎæÎòÎÉ ÎøÎÉÎƒ... Î¿ÎÖÎùÎòÎ¬ Î®Î£ ${product.category} ÎæÎ®ÎÖÎ£ÎòÎæ Î¬ÎòÎòÎÖÎØ ÎÖÎÖÎùÎòÎôÎÖÎÖÎØ.`}
                        </div>
                    ...
                    <div className="space-y-6">
                        <h3 className="font-bold mb-4">ÎæÎùÎ¿ ÎÆÎòÎôÎ£ ÎòÎöÎòÎíÎú Î£ÎíÎ£:</h3>
...

            {
                related.length > 0 && (
                    <div>
                        <h2 className="text-2xl font-bold mb-8">ÎÉÎòÎ£ÎÖ Î¬ÎÉÎöÎæ\ÎÖ ÎÆÎØ</h2>
